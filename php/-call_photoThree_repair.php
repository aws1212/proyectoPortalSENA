...
<?php
    ...
    {
                $sqls = "SELECT id_photo,foto_tres FROM Fotografia_orden WHERE id_reparacion = '$id_reparation' AND placa = '$placa'";
                ...
                {
                    $linkCurrent = $row['foto_tres'];
                    $string_Clear = substr($linkCurrent,51);
